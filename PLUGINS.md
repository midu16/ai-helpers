...
**Commands:**
- **`/jira:analyze-rds-report` `[--file <path.md>] [--partner <vendor> [RAN|CORE]] | [full RDS Analyzer report text]`** - Parse RDS Analyzer reports and create ECOPS guidance tasks for section B items
